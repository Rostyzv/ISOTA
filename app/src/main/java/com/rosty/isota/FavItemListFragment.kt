...
import com.marisma.ejemplorecyclerview.adapter.PersonajesAdapter
...
class FavItemListFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val fotosFavoritas = PersonajesProvider.listaEquipos.filter { it.fav }

        // Obtener el RecyclerView del diseño
        val recyclerView = view.findViewById<RecyclerView>(R.id.recyclerLaLiga)
        ...
        val fotoAdapter =PersonajesAdapter(fotosFavoritas){}
